...
export default function AdsSection(){
    return (
        ...
        <div className={`relative flex flex-col py-10 justify-center items-center px-32 mt-8 rounded-lg bg-[#D9D0FF] bg-[url('/image71.jpeg')] bg-cover bg-center`}>
            ...
            <div className="flex flex-row gap-3 my-24 ">
                <button className={`px-9 py-4 rounded-full bg-primary_accent hover:text-white text-black hover:scale-110 hover:shadow-lg hover:shadow-gray-900 ${simpleButtonTransitionClass}`}>همین الان خرید کن</button>
