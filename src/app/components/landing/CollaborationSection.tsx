...
export default function CollaborationSection() {
  ...
  return (
    <div className={`relative grid grid-cols-1 h-[90vh] grid-rows-2 gap-10 px-32 mt-8 rounded-lg bg-primary_accent bg-[url('/grid/grid_svg1.svg')] bg-center bg-cover`}>
      ...
      <div className="flex flex-row grid-cols-3 mb-5 py-4 gap-3">
        <Image
          className={`w-[80%] rounded-lg border-4 border-white bg-contain bg-[url('/image96.jpeg')] bg-center ${simpleButtonTransitionClass} hover:scale-90 hover:shadow-lg hover:shadow-gray-400`}
          src={FashionImaget4}
          alt='fashion'
        />  
        ...
        <div className="flex flex-col gap-7 h-full">
          <Image
            className={`rounded-lg col-span-1 w-full h-full bg-orange-300 border-4 border-white ${simpleButtonTransitionClass} hover:scale-95 hover:shadow-lg hover:shadow-gray-400`}
              src={FashionImaget1}
              alt="e" />
          <Image
            className={`rounded-lg w-full border-4 h-full border-white ${simpleButtonTransitionClass} hover:scale-95 hover:shadow-lg hover:shadow-gray-400`}
            src={FashionImaget3}
            alt="e" />
        </div> 

        <Image
          className={`rounded-lg w-full  border-4 border-white ${simpleButtonTransitionClass} hover:scale-90 hover:shadow-lg hover:shadow-gray-400`}
            src={FashionImaget2}
            alt="e" />
